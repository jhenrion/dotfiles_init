...
- The installation and runcom setup is
  [tested weekly on real Ubuntu and macOS machines](https://github.com/jhenrion/dotfiles/actions) using
...
```bash
bash -c "`curl -fsSL https://raw.githubusercontent.com/jhenrion/dotfiles/master/remote-install.sh`"
```
...
```bash
git clone https://github.com/jhenrion/dotfiles.git ~/.dotfiles
```
...
[GitHub Action](https://github.com/jhenrion/dotfiles/actions).
...
- [Awesome Dotfiles](https://github.com/jhenrion/awesome-dotfiles)
